...
//			$this->items_per_page = $this->default_ipp;
        ...
        if ($this->num_pages > 10) {
            ...
            $this->return .= ($this->current_page == 'All') ? "<a class=\"current  hide\" style=\"margin-left:10px\" href=\"#\">All</a> \n" : "<a class=\"paginate  hide\" style=\"margin-left:10px\" href=\"$_SERVER[PHP_SELF]?page=1&ipp=All$this->querystring\">All</a> \n";
        }
        else {
            for ($i = 1; $i <= $this->num_pages; $i++) {
            ...
            $this->return .= "<a class=\"paginate hide\" href=\"$_SERVER[PHP_SELF]?page=1&ipp=All$this->querystring\">All</a> \n";
        }
