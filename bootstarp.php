...
<div class="container-fluid">
  ...
  <div class="row">
    <div class="col-sm-6 col-md-6 panel-info" style="background-color: nonelavender;height:470px;">
      <div class="panel-heading"><b>My List</b>
    </div>
    ...
    <div class="col-md-12">
      <div class="row">
        <div id="switchlist" class="panel-warning col-md-6 ">
          <div class="panel-heading" id="delete_mylists">
            <b>My Device List </b>
          ...
          <div class ="panel-body">
            <table  width="100%"  id="<?php echo $device['id'] ?>" class="myswlist table table-border">
              <thead>
                <tr>
                  <th>List name  </th><th> Edit </th><th>View</th>           
                </tr>
              </thead>
              <tbody> 
              <?php  
      ...
      if (isset( $_SESSION['switchlistid'] )) {
        ...
        <div class="col-md-6 panel-warning">
          <div class="panel-heading" id="mylist_delete" >
    ...
    <div class="row">
      ...
      <div  id="container_mymarketswitches" class="panel-body"> 
        ...
        <?php
          ...
          // Highest possible listing item when map is invisible
          $high_limit = HIGH_LIMIT;

          // Highest possible listing item when map is Visible
          $low_limit = LOW_LIMIT;
